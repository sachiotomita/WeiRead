package com.hsf1002.sky.weread.widget.page;
...
import com.hsf1002.sky.weread.utils.IOUtils;
...
public abstract class PageLoader {
    ...
    public void setBgColor(int theme) {
        if (isNightMode && theme == ReadSettingManager.NIGHT_MODE) {
            mTextColor = ContextCompat.getColor(WeReadApplication.getAppContext(), R.color.color_fff_99);
            mPageBg = ContextCompat.getColor(WeReadApplication.getAppContext(), R.color.black);
        } else if (isNightMode) {
            mBgTheme = theme;
            ...
            switch (theme) {
                case ReadSettingManager.READ_BG_DEFAULT:
                    mTextColor = ContextCompat.getColor(WeReadApplication.getAppContext(), R.color.color_2c);
                    mPageBg = ContextCompat.getColor(WeReadApplication.getAppContext(), R.color.color_cec29c);
                    break;
                case ReadSettingManager.READ_BG_1:
                    mTextColor = ContextCompat.getColor(WeReadApplication.getAppContext(), R.color.color_2f332d);
                    mPageBg = ContextCompat.getColor(WeReadApplication.getAppContext(), R.color.color_ccebcc);
                    break;
                case ReadSettingManager.READ_BG_2:
                    mTextColor = ContextCompat.getColor(WeReadApplication.getAppContext(), R.color.color_92918c);
                    mPageBg = ContextCompat.getColor(WeReadApplication.getAppContext(), R.color.color_aaa);
                    break;
                case ReadSettingManager.READ_BG_3:
                    mTextColor = ContextCompat.getColor(WeReadApplication.getAppContext(), R.color.color_383429);
                    mPageBg = ContextCompat.getColor(WeReadApplication.getAppContext(), R.color.color_d1cec5);
                    break;
                case ReadSettingManager.READ_BG_4:
                    mTextColor = ContextCompat.getColor(WeReadApplication.getAppContext(), R.color.color_627176);
                    mPageBg = ContextCompat.getColor(WeReadApplication.getAppContext(), R.color.color_001c27);
                    break;
            }
        }
    ...
    public void saveRecord() {
        ...
        //存储到数据库
        BookRecordHelper.getInstance().saveRecordBook(mBookRecord);
    }
    ...
    public void openBook(CollBookBean collBook) {
        ...
        //从数据库取阅读数据
        mBookRecord = BookRecordHelper.getInstance()
