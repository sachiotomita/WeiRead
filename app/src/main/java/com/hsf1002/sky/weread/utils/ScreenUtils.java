...
public class ScreenUtils {
    ...
    public static int getStatusBarHeight() {
        Resources resources = WeReadApplication.getAppContext().getResources();
    ...
    public static int getNavigationBarHeight() {
        ...
        Resources rs = WeReadApplication.getAppContext().getResources();
    ...
    public static DisplayMetrics getDisplayMetrics() {
        DisplayMetrics metrics = WeReadApplication.getAppContext()
                .getResources()
                .getDisplayMetrics();
        return metrics;
    }
